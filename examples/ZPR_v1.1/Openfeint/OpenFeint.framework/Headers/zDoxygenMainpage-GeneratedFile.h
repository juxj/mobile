...
@image html of_devSupport.png 
			...
			<h3>Platform: OpenFeint iOS SDK 2.12.2</h3>
			<h4>Readme.html for OpenFeint iOS SDK 2.12.2<br>Release date 08.31.2011 <br>
				Release Notes Copyright (c) 2009-2011 OpenFeint Inc. <br>
				All Rights Reserved. 
			</h4>
			A complete set of the OpenFeint iOS 2.12.2 API Documentation can be seen at 
			<a href="http://support.openfeint.com/images/ref/2.12.2-OFSDK-iOS/APIdocumentation/index.html">http://support.openfeint.com/images/ref/2.12.2-OFSDK-iOS/APIdocumentation/index.html</a>.
			Note: A version of this README can also be downloaded <a href="http://support.openfeint.com/images/ref/2.12.2-OFSDK-iOS/OF2.12.2_APIdocumentation.zip">here</a>; the on-line version may have updated information not included below.
			<h3>&nbsp;&nbsp;In this document&nbsp;&nbsp;</h3>
			<ul>
				<li><a href="#new">&nbsp;&nbsp;New in OpenFeint iOS SDK Version 2.12.2&nbsp;&nbsp;</a>
...
<a name="new"></a><h3>New in OpenFeint iOS SDK Version 2.12.2</h3>
<ul>
