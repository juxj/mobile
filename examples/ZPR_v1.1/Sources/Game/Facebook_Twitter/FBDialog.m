...
//		[cancelBtn setFrame:CGRectMake(14, 63, 78, 30)];
...
- (void)webViewDidFinishLoad:(UIWebView *)webView {
	...
	NSString *urlString_ = [[webView.request URL] absoluteString];
	NSString *loginFB = [NSString stringWithString:@"refid=0"];
	NSString *loginTW1 = [NSString stringWithString:@"https://twitter.com/"];
//    NSString *loginTW2 = [NSString stringWithString:@"https://mobile.twitter.com/"];

	NSRange rangeFB_ = [urlString_ rangeOfString:loginFB];
	NSRange rangeTW_ = [urlString_ rangeOfString:loginTW1];
	if ((rangeFB_.length != 0 && rangeTW_.length == 0) || [urlString_ isEqualToString:loginTW1]) {
		UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Share successfully!" message:@"" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
		[alert show];
		[alert release];
		[self dialogDidCancel:nil];
	}
...
- (void)showTwitter {
	...
	NSString* webStringURL = [_serverURL stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
	_loadingURL = [[NSURL URLWithString:webStringURL] retain];
    NSMutableURLRequest* request = [NSMutableURLRequest requestWithURL:_loadingURL];
...
- (void)dismissWithSuccess:(BOOL)success animated:(BOOL)animated {
	...
	[notification postNotificationName:@"LOGOUT" object:nil];
}
...
//	ZPRAppDelegate *delegate_ = (ZPRAppDelegate *) [[UIApplication sharedApplication] delegate];
//    [[delegate_ facebook] logout:self];
}
